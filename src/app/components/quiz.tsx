...
export default function Quiz({
	...
	const handleNextFlag = () => {
		if (currentIndex + 1 >= countryIndices.length) {
	...
	return (
		<div className="flex pt-6 sm:pt-16 justify-center min-h-full">
			<div className="flex flex-col items-center gap-10 w-full px-4 sm:w-[400px] ">
				...
				{!showAnswer && !isQuizFinished &&<Button onClick={() => handleSubmit()}>Submit</Button>}
				{showAnswer && selectedCountry && selectedCapital && !isQuizFinished &&(
